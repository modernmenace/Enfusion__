...
QuestDisplay::QuestDisplay() : q_title("Active Quests", sf::Vector2f(700, -225), 27)
{
    q_dropBox.addComponent<Position>(sf::Vector2f(900, -225));
...
void QuestDisplay::initialize()
{
    Entity::initialize();
    q_title.initialize();
    q_title.setTextColor(sf::Color::Yellow);
